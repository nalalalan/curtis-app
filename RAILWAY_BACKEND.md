...
- Piece names require clear confidence and independent audio verification through `/api/curtis/piece-id/run`; possible, uncorroborated, or user-rejected repertoire guesses are normalized to `Piece being identified`.
