...
- Daily records group same-day practice videos, preserve uploaded duration separately from real active violin-playing time, and show playable local audio/video evidence when media has been processed. Machine note/rhythm evidence now combines onset-aware pYIN with an onset-bounded spectral pitch rescue for fast passages; usable unverified events render as audio-paired draft notation, while repeated single-note traces such as D-D-D-D remain out of training and final score-verified notation.
