...
- Repertoire names require clear confidence plus independent audio verification. Possible or uncorroborated model guesses stay hidden as `Piece being identified`.
