...
- Daily records group same-day practice videos and preserve uploaded duration separately from real active violin-playing time. Playable audio/video evidence and draft notation only surface when the source media window is explicitly violin-positive; unverified room/setup/laptop audio is withheld instead of being counted as practice evidence. Machine note/rhythm evidence combines onset-aware pYIN with an onset-bounded spectral pitch rescue for fast passages, while repeated single-note traces such as D-D-D-D remain out of training and final score-verified notation.
