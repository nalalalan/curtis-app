...
Current accepted score match & 1 actual-source score crop is accepted for the Staff 4 \texttt{Eb5 Eb5 C5 Eb5 Eb5 Eb5} window. The 2026-05-03 \texttt{Bb4 D5 C5 Bb4 D5} Scherzo-Tarantelle crop, the old A4/A5 single-note anchors, and the previous D--B-flat--G--D score extraction are all rejected fixtures. The right-2 \texttt{Eb5 Eb5 C5 Eb5 Eb5 Eb5 C5} source lane is still not accepted until its full seven-note score/audio/crop/truth state is audited; 951 local score glyph candidates, 214 staff-position notehead hypotheses, 8 staff review packets, and source-verification targets are queued for truth review but are not accepted score evidence. \\
