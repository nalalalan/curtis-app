...
Current archive coverage & 213 h 23 min uploaded practice video across 46 strict-ledger videos and 39 practice days; 2 h 1 min 30 s checked; 1 h 58 min 54 s measured active violin; 211 h 22 min still unchecked. \\
Current estimate & 208 h 49 min total active practice estimated from checked windows; provisional and sample-biased until the full chronological scan covers the archive. \\
...
M1 & Practice time & All 213 h 23 min of strict-ledger video has active-practice coverage and per-day totals. & Active-scan route deployed; live state now has 215 active intervals from 82 sample results; queue-only owner sync checked the first chronological \texttt{violin 1} window as non-playing; full chronological scan still pending. \\
...
\begin{enumerate}
    \item keep running queue-only owner-media sync against the active-scan queue, starting with \texttt{violin 1} at \texttt{*90-180};
