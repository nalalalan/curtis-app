...
M1 & Practice time & All 213 h 23 min of strict-ledger video has active-practice coverage and per-day totals. & Active-scan route deployed; live state now has 215 active intervals from 81 sample results; owner sync can consume queued scan windows; full chronological scan still pending. \\
...
\begin{enumerate}
    \item run owner-media sync against the active-scan queue and upload the next chronological pending windows;
