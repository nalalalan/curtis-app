...
M1 & Practice time & All 213 h 23 min of strict-ledger video has active-practice coverage and per-day totals. & Active-scan route deployed; live state now has 250 active intervals from 90 sample results; queue-only owner sync checked \texttt{violin 1} through \texttt{*720-810}; full chronological scan still pending. \\
