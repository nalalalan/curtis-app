...
Current accepted score match & 0 exact score-aligned snippets; the Wieniawski source score PDF is now local, but symbolic measures are still pending. \\
...
M2 & Score truth & Scherzo-Tarantelle has verified symbolic notes and score coordinates. & Partially advanced; the local source PDF is present and audited, but the verified symbolic Scherzo-Tarantelle measure is still missing. \\
M3 & One-note anchor & A displayed A from audio is matched to a verified score-side A, with no wrong-note crop. & Pending. \\
M4 & Short sequence & Three-to-five played notes align to exact score notes and render with local audio/video. & Pending; tests now prove such a verified phrase will count, but no live accepted phrase exists. \\
