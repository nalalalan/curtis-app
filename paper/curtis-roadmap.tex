...
\begin{enumerate}
    ...
    \item improve the adjacent note-window inference if the expected \texttt{Eb5} is being probed before or after the actual played onset;
    \item improve detector voting if the probed audio segment visibly/audibly contains the expected adjacent source note but pYIN/YIN/spectral disagreement blocks it;
