...
M2 & Score truth & Scherzo-Tarantelle has verified symbolic notes and score coordinates. & Advanced; nine opening notes plus one Staff 4 five-note source window are verified in MusicXML. Broader score coordinates remain pending. \\
...
M10 & Regression lock & Tests prevent failed notation, wrong score boxes, and non-playing practice-time credit from returning. & Advanced; exact-MIDI manifest verifies two positive source phrases, accepts one live source/audio phrase, and blocks three false phrase maps. \\
\bottomrule
\end{tabularx}
\end{table}
