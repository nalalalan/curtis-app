...
M10 & Regression lock & Tests prevent failed notation, wrong score boxes, and non-playing practice-time credit from returning. & Advanced; exact-MIDI manifest verifies three positive source phrases, accepts one live source/audio phrase, and blocks three false phrase maps. \\
\bottomrule
\end{tabularx}
\end{table}
