...
\begin{enumerate}
    \item promote the accepted six-note Staff 4 lane into the visible compact grouped score--clip--audio--transcription pair after live deploy verification;
    \item generate or update the next Staff 4 right-2 audit packet for \texttt{Eb5 Eb5 C5 Eb5 Eb5 Eb5 C5};
