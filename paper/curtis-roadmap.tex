...
\begin{enumerate}
    \item widen the Staff 4 source-audio rescan if the first padded window still lacks an exact adjacent \texttt{Eb5} run;
    \item improve segmentation around the accepted anchor if the rescanned event stream still collapses or skips fast adjacent notes;
