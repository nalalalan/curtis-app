...
\metric{Pitch/rhythm transcription}{Onset-aware violin-range pYIN configured; per-sample note events, quality gates, and fingerprints stored when media samples exist}
...
\metric{Daily evidence surface}{Embedded local sample, notation, score heat-map target, and explicit whole-session limit}
