...
\metric{Machine pitch events}{Detected-active-section harmonic pYIN with pitch-sanity filtering, quality gates, active-coverage fields, and fingerprints stored when media samples exist; events are hidden from the music view until score alignment is reliable}
