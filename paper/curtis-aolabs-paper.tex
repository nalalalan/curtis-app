...
\metric{Estimated total practice time}{201 h 24 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
\metric{Measured practice time}{2 h 6 min of detected violin-playing footage; this is independent from transcription and cannot exceed checked video coverage}
\metric{Video checked for practice time}{2 h 13 min of the 213 h 23 min uploaded-video ledger}
\metric{Active-practice scan}{269 active sub-intervals persisted from stored media samples; 48 min 21 s of scan-derived active audio; 94 sample results; \texttt{violin 1} windows through \texttt{*1080-1170} checked; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{211 h 10 min still awaiting violin-playing detection}
\metric{Media samples}{94 active-scan sample results; 84 active violin; 10 checked non-violin}
