...
\metric{Active practice time}{6 min 33 s counted only from violin-positive media windows; uploaded duration is reported separately}
\metric{Unmeasured archive duration}{179 h 41 min still awaiting full media segmentation}
\metric{Media samples}{46 indexed windows; 13 violin-positive; 31 withheld}
