...
\metric{Transcription solve tracker}{Tracker now awards accepted long-phrase progress only for exact source-score location, at least five contiguous source notes, local playable audio/video, and non-anchor status; source truth now contains 7 unique symbolic score notes and 1 verified source snippet}
