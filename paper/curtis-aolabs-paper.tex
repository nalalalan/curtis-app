...
\metric{Estimated total practice time}{203 h 14 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
\metric{Measured practice time}{2 h of detected violin-playing footage; this is independent from transcription and cannot exceed checked video coverage}
\metric{Video checked for practice time}{2 h 6 min of the 213 h 23 min uploaded-video ledger}
\metric{Active-practice scan}{250 active sub-intervals persisted from stored media samples; 46 min 11 s of scan-derived active audio; 90 sample results; \texttt{violin 1} windows through \texttt{*720-810} checked; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{211 h 17 min 50 s still awaiting violin-playing detection}
\metric{Media samples}{90 active-scan sample results; 80 active violin; 10 checked non-violin}
