...
A later deployment check at 2026-05-14 05:23 AM EDT verified the first accepted source-backed score/audio measure. The accepted 2026-05-03 Scherzo-Tarantelle group reports detected pitch classes \texttt{D A\# G D} against symbolic score pitch classes \texttt{D A\# G D}; the score notes are \texttt{D5}, written \texttt{Bb4}, \texttt{G4}, and \texttt{D5}. The live transcription tracker now reports 43.642 percent exact progress, one accepted measure match, one exact score-aligned window, and zero accepted long phrases. This is measure-level progress only; long-phrase transcription remains unsolved.
...
\metric{Transcription solve tracker}{43.642\% exact weighted progress; 1 accepted measure match; 1 exact score-aligned window; 0 accepted long phrases}
