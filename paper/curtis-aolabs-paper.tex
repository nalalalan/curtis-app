...
\centering
\small
\caption{Curtis production state checked at 2026-05-09 02:11 UTC.}
\label{tab:state}
...
\metric{Active practice time}{8 min 54 s counted only from violin-positive media windows; uploaded duration is reported separately}
...
\metric{Analyzed practice days}{35 indexed days; 5 active-time measured daily records; 3 audio-evidence records; 1 verified micro-transcription record; 3 confirmed source labels with score snippets}
