...
The production state uses the live backend at \url{https://curtis.aolabs.io/api/curtis/media-status}. The checked source state at 2026-05-13 03:37 PM EDT reported the values in Table~\ref{tab:state}. These are operating facts, not outcome claims.
...
\caption{Curtis source state checked at 2026-05-13 03:37 PM EDT.}
\label{tab:state}
...
\metric{Active-practice scan}{215 active sub-intervals persisted from stored media samples; 42 min 9 s of scan-derived active audio; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{211 h 23 min still awaiting violin-playing detection}
\metric{Media samples}{81 active-scan sample results; 72 active violin; 9 checked non-violin}
