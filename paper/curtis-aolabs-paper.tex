...
\metric{Estimated total practice time}{197 h 40 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
\metric{Measured practice time}{2 h 12 min of detected violin-playing footage; this is independent from transcription and cannot exceed checked video coverage}
\metric{Video checked for practice time}{2 h 22 min of the 213 h 23 min uploaded-video ledger}
\metric{Active-practice scan}{300 active sub-intervals persisted from stored media samples; 50 min 44 s of scan-derived active audio; 100 sample results; \texttt{violin 1} windows through \texttt{*1620-1710} checked; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{211 h 1 min still awaiting violin-playing detection}
\metric{Media samples}{100 active-scan sample results; 88 active violin; 12 checked non-violin}
