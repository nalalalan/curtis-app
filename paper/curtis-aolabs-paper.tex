...
\metric{Note-match windows}{No accepted Scherzo-Tarantelle score match is currently displayed after the 2026-05-03 five-note crop was demoted; detected notes \texttt{A\#4 D5 C5 A\#4 D5} remain a symbolic phrase candidate only because the visible notes in the actual source-score crop did not match the transcription; longer phrase and rhythm transcription remain unsolved}
\metric{Transcription solve tracker}{45.628\% expected exact weighted progress after truth-workbench and visible-note-sequence gate update, assuming the live practice-time and score-queue state is otherwise unchanged; 0 accepted long phrases; 0 accepted measure matches; 0 exact score-aligned windows; 0 score-coordinate heat-map fragments; 0 score-visual locks; 0 actual-source score locks; 0 accepted truth items; 4 source-verification targets queued for truth review; 4 source-target score checks; 0 verified source targets; 7 verified symbolic score notes; 0 verified source snippets; 951 unaccepted score glyph candidates; 214 unaccepted score-note hypotheses; 8 staff review packets}
