...
\metric{Pitch/rhythm transcription}{Filtered monophonic violin-range pYIN configured; per-sample note events and fingerprints stored when media samples exist}
