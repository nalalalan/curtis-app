...
\centering
\small
\caption{Curtis production state checked at 2026-05-09 01:56 UTC.}
\label{tab:state}
...
\metric{Analyzed practice days}{35 indexed days; 5 processed daily records; 5 audio-evidence records; 0 verified transcription records; 3 confirmed source labels with score snippets}
