...
\metric{Estimated total practice time}{199 h 19 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
\metric{Measured practice time}{2 h 7 min of detected violin-playing footage; this is independent from transcription and cannot exceed checked video coverage}
\metric{Video checked for practice time}{2 h 16 min of the 213 h 23 min uploaded-video ledger}
\metric{Active-practice scan}{283 active sub-intervals persisted from stored media samples; 49 min 21 s of scan-derived active audio; 96 sample results; \texttt{violin 1} windows through \texttt{*1260-1350} checked; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{211 h 7 min still awaiting violin-playing detection}
\metric{Media samples}{96 active-scan sample results; 85 active violin; 11 checked non-violin}
