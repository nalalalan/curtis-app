...
\metric{Pitch/rhythm transcription}{Detected-active-section harmonic pYIN with pitch-sanity filtering; per-section note events, sparse-window omission, quality gates, active-coverage fields, and fingerprints stored when media samples exist}
...
\metric{Daily evidence surface}{Transcription-paired local sample, notation, score heat-map target, and explicit whole-session limit}
