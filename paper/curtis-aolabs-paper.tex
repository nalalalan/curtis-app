...
A later deployment check at 2026-05-14 05:40 AM EDT verified the first accepted source-backed score/audio measure and the corrected source-target accounting state. The accepted 2026-05-03 Scherzo-Tarantelle group reports detected pitch classes \texttt{D A\# G D} against symbolic score pitch classes \texttt{D A\# G D}; the score notes are \texttt{D5}, written \texttt{Bb4}, \texttt{G4}, and \texttt{D5}. The live transcription tracker now reports 45.142 percent exact progress, one accepted measure match, one exact score-aligned window, three score targets, one local score PDF, eight symbolic score notes, one exact score location, and zero accepted long phrases. This is measure-level progress only; long-phrase transcription remains unsolved.
...
\metric{Note-match windows}{1 deployed source-backed symbolic Scherzo-Tarantelle measure match on 2026-05-03; detected pitch classes \texttt{D A\# G D} match score pitch classes \texttt{D A\# G D}; accepted long phrases remain 0}
\metric{Transcription solve tracker}{45.142\% exact weighted progress; 1 accepted measure match; 1 exact score-aligned window; 3 score targets; 1 local score PDF; 8 symbolic score notes; 1 exact score location; 0 accepted long phrases}
