...
\metric{Transcription solve tracker}{58.633\% exact weighted progress after source-target triage; 1 accepted long phrase; 2 accepted measure matches; 2 exact score-aligned windows; 2 score-coordinate heat-map fragments; 12 pitch-sequence groups; 3 source-verification targets; 3 source-target score checks; 0 verified source targets; 7 unique symbolic score notes; 1 verified source snippet}
