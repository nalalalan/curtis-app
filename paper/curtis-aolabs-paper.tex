...
\metric{Estimated total practice time}{65 h 8 min extrapolated from the checked-window active-playing ratio; approximate until the full archive scan completes}
\metric{Measured practice time}{29 min 9 s of detected violin-playing footage; this is independent from transcription}
...
\metric{Analyzed practice days}{37 indexed days; 5 practice-time measured daily records; 5 audio-evidence records; 4 score-audio-only records; 1 detected-note-fragment record; 3 confirmed source labels with score targets, 16 pitch-sequence score groups, and 0 exact score-matched snippets}
...
\metric{Score-linked windows}{16 pitch-sequence score-reference groups; 0 exact score-aligned windows}
