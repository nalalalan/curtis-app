...
\metric{Estimated total practice time}{198 h 18 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
\metric{Measured practice time}{2 h 18 min of detected violin-playing footage; this is independent from transcription and cannot exceed checked video coverage}
\metric{Video checked for practice time}{2 h 28 min of the 213 h 23 min uploaded-video ledger}
\metric{Active-practice scan}{322 active sub-intervals persisted from stored media samples; 52 min 54 s of scan-derived active audio; 104 sample results; \texttt{violin 1} windows through \texttt{*1980-2070} checked; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{210 h 55 min still awaiting violin-playing detection}
\metric{Media samples}{104 active-scan sample results; 92 active violin; 12 checked non-violin}
