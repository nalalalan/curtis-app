...
\metric{Active practice time}{3 min 18 s counted only from violin-positive media windows; uploaded duration is reported separately}
\metric{Unmeasured archive duration}{179 h 44 min still awaiting full media segmentation}
\metric{Media samples}{24 indexed windows; 7 violin-positive; 17 withheld}
...
\metric{Analyzed practice days}{35 indexed days; 3 processed daily records; 3 audio-evidence records; 0 verified transcription records; 3 confirmed source labels with score snippets}
