...
\metric{Analyzed practice days}{37 indexed days; 5 practice-time measured daily records; 5 audio-evidence records; 4 score-audio-only records; 1 detected-note-fragment record; 3 confirmed source labels with score targets, 16 pitch-sequence note-match groups, and 0 exact score-matched snippets}
...
\metric{Note-match windows}{16 pitch-sequence note-match groups; 0 exact score-aligned windows}
