...
\metric{Pitch/rhythm transcription}{Detected-active-section harmonic pYIN configured; per-section note events, quality gates, active-coverage fields, and fingerprints stored when media samples exist}
