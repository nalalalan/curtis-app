...
\metric{Estimated total practice time}{199 h 37 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
\metric{Measured practice time}{2 h 10 min of detected violin-playing footage; this is independent from transcription and cannot exceed checked video coverage}
\metric{Video checked for practice time}{2 h 19 min of the 213 h 23 min uploaded-video ledger}
\metric{Active-practice scan}{294 active sub-intervals persisted from stored media samples; 50 min 22 s of scan-derived active audio; 98 sample results; \texttt{violin 1} windows through \texttt{*1440-1530} checked; 250 queued windows still pending owner media}
\metric{Unchecked archive duration}{211 h 4 min still awaiting violin-playing detection}
\metric{Media samples}{98 active-scan sample results; 87 active violin; 11 checked non-violin}
