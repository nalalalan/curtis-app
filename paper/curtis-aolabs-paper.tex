...
\metric{Active practice time}{Counted only from detected violin-playing windows; uploaded duration is reported separately}
...
\metric{Analyzed practice days}{40 title-confirmed daily records; 3 confirmed source labels with score snippets}
