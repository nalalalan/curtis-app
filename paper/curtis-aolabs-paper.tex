...
\caption{Curtis source state checked at 2026-05-14 03:00 AM EDT.}
\label{tab:state}
...
\metric{Uploaded-video ledger}{46 videos, 213 h 23 min uploaded session duration}
\metric{Estimated total practice time}{198 h 36 min extrapolated from the checked-window active-playing ratio; provisional because the checked windows remain sparse and sample-biased}
...
\metric{Video checked for practice time}{2 h 31 min of the 213 h 23 min uploaded-video ledger}
...
\metric{Unchecked archive duration}{210 h 52 min still awaiting violin-playing detection}
...
\metric{Analyzed practice days}{39 indexed days; 3 practice-time measured daily records; 3 audio-evidence records; 2 score-audio-only records; 1 detected-note-fragment record; 3 confirmed source labels, score targets, and a source-backed Wieniawski seven-note symbolic opening phrase}
...
\metric{Transcription solve tracker}{63.633\% exact weighted progress after staff review-packet update; 1 accepted long phrase; 2 accepted measure matches; 2 exact score-aligned windows; 2 score-coordinate heat-map fragments; 12 pitch-sequence groups; 3 source-verification targets; 3 source-target score checks; 0 verified source targets; 7 verified symbolic score notes; 1 verified source snippet; 951 unaccepted score glyph candidates; 214 unaccepted score-note hypotheses; 8 staff review packets}
