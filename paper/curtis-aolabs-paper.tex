...
\metric{Machine pitch events}{Detected-active-section onset-aware pYIN with pitch-sanity filtering, repeated-pitch-collapse guarding, active-coverage fields, and fingerprints stored only when quality gates pass; unverified events remain paired audio evidence until score alignment is reliable}
