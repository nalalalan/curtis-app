...
\metric{Analyzed practice days}{35 indexed days; 7 processed daily records; 5 audio-evidence records; 0 verified transcription records; 3 confirmed source labels with score snippets}
\metric{Machine pitch events}{Detected-active-section onset-aware pYIN with pitch-sanity filtering, repeated-pitch-collapse rejection, active-coverage fields, and fingerprints stored only when quality gates pass; events are hidden from the music view until score alignment is reliable}
