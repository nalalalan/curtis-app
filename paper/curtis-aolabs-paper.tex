...
\metric{Active practice time}{7 min 54 s counted only from detected violin-playing windows; uploaded duration is reported separately}
...
\metric{Pitch/rhythm transcription}{Harmonic-isolated onset-aware violin-range pYIN configured; per-sample note events, quality gates, coverage fields, and fingerprints stored when media samples exist}
