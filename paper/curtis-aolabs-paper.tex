...
The production state uses the live backend at \url{https://curtis.aolabs.io/api/curtis/media-status}. The checked source state at 2026-05-13 12:33 PM EDT reported the values in Table~\ref{tab:state}. These are operating facts, not outcome claims.
...
\caption{Curtis source state checked at 2026-05-13 12:33 PM EDT.}
\label{tab:state}
...
\metric{Estimated total practice time}{94 h 39 min extrapolated from the checked-window active-playing ratio; approximate until the full archive scan completes}
\metric{Measured practice time}{53 min 14 s of detected violin-playing footage; this is independent from transcription}
