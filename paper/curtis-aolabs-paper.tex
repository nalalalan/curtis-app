...
The backend is a FastAPI service deployed on Railway. It exposes \url{https://curtis.aolabs.io/api/curtis/media-status} for compact state, \url{https://curtis.aolabs.io/api/curtis/ops-check} for fuller operational state, and run endpoints for scans, media probing, analysis, and coaching. Persistent runtime state stores sources, inventory, review findings, media samples, analysis runs, and scan history.
