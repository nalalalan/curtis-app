...
\metric{Note-match windows}{Pitch-sequence note-match groups plus a source-backed symbolic Scherzo-Tarantelle opening motif; exact live score-aligned counts update only after deployment verification}
