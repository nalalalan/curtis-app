...
def wieniawski_reference_target() -> dict[str, Any]:
    return {
        ...
        "symbolicScore": {
            "sourceId": "wieniawski-scherzo-tarantelle-opening-symbolic-v5",
            ...
            "source": "Manually verified symbolic excerpt from the local IMSLP solo-violin PDF, page 2, cross-checked against the Wieniawski Society bars 5-9 example image. The visible opening phrase begins A5-G5-F5-A5-G5-F5-A5-G#5-F5; the previous D6-C6-Bb5 source sequence, lower-octave D5-C5-Bb4 map, and D-Bb-G-D source sequence are rejected.",
        ...
        "symbolicScoreStatus": "source_symbolic_opening_phrase_review_pending",
