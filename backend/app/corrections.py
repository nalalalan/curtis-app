...
def wieniawski_reference_target() -> dict[str, Any]:
    return {
        ...
        "symbolicScore": {
            "sourceId": "wieniawski-scherzo-tarantelle-opening-symbolic-v3",
            ...
            "sourceSnippets": [
                ...
                },
                {
                    ...
                    "rejectionReason": "The visible score crop does not show the same note sequence/register as the transcription; it cannot be displayed as a note match.",
                }
            ],
        },
        "symbolicScoreStatus": "source_verified_symbolic_opening_long_phrase_ready",
