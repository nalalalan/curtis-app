...
def wieniawski_reference_target() -> dict[str, Any]:
    return {
        ...
        "symbolicScore": {
            "sourceId": "wieniawski-scherzo-tarantelle-opening-symbolic-v1",
            ...
            "source": "Manually verified symbolic excerpt from the local IMSLP solo-violin PDF, page 2.",
        ...
        "symbolicScoreStatus": "source_verified_symbolic_opening_motif_ready",
