...
def wieniawski_reference_target() -> dict[str, Any]:
    return {
        ...
        "symbolicScore": {
            "sourceId": "wieniawski-scherzo-tarantelle-opening-symbolic-v2",
            ...
            "source": "Manually verified symbolic excerpt from the local IMSLP solo-violin PDF, page 2. The visible opening phrase is D-C-Bb-D-C-Bb; the previous D-Bb-G-D source sequence is rejected.",
            ...
            "sourceSnippets": [
                {
                    "referenceStart": 0,
                    "referenceEnd": 6,
                    "label": "opening D-C-Bb-D-C-Bb",
                    "imageUrl": "/assets/score/wieniawski-scherzo-tarantelle-opening-d-c-bb-d-source.png",
                    "sourcePdfPage": 2,
        ...
        "symbolicScoreStatus": "source_verified_symbolic_opening_phrase_ready",
        ...
        "scoreNoteCropStatus": "no_visual_note_verified_anchor_ready",
